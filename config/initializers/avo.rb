...
Avo.configure do |config|
  ...
  config.home_path = "/admin/resources/participants"
  ...
  config.authenticate_with do
    authenticate_or_request_with_http_basic("SF Ruby Clouds") do |username, password|
  ...
  config.app_name = "SF Ruby Clouds"
  # config.timezone = "UTC"
  # config.currency = 'USD'
